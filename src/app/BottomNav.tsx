...
import HumorRegistration from './HumorRegistration';
import HabitTrackerScreen from './HabitTrackerScreen';
import SelfCareScreen from './SelfCareScreen';
import MeditationScreen from './MeditationScreen';
import { Home, Smile, TrendingUp, Heart, Brain } from 'lucide-react-native';
...
interface BottomNavProps {
  setNavigationState: (state: 'welcome' | 'main') => void;
}
