...
export interface Session {
  ...
  iconName: keyof typeof Feather.glyphMap; // Nome do ícone Feather
      ...
      <View style={styles.contentRow}>
        ...
        <View style={styles.textContainer}>
          ...
          <View style={styles.footerRow}>
            ...
            {/* Botão Começar */}
            <TouchableOpacity style={styles.startButton} onPress={() => onPress(session.id)}>
...
const styles = StyleSheet.create({
  ...
  iconWrapper: {
    width: 60,
    height: 60,
    borderRadius: 12, // Borda levemente arredondada
  ...
  startButton: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#333333', // Cor preta/escura para o botão
    borderRadius: 8,
