...
// EXPORTADO CORRETAMENTE: A tipagem está disponível para outros arquivos.
export interface Activity { 
  title: string;
  description: string;
  time: number; // em minutos
  difficulty: 'fácil' | 'médio' | 'difícil'; // Tipagem restrita (literal)
  benefit: string;
}
...
const ActivityCard: React.FC<ActivityCardProps> = ({ activity }) => {
  // Lógica para cor da tag de dificuldade (simulando o verde para "fácil")
  ...
  return (
    <View style={styles.cardContainer}>
      ...
      {/* Detalhes (Tempo, Dificuldade, Benefício) */}
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.detailItem}>
          ...
          <View style={[styles.difficultyTag, { backgroundColor: tagBgColor }]}>
            <Text style={[styles.difficultyText, { color: tagColor }]}>{activity.difficulty}</Text>
          </View>
        </View>
